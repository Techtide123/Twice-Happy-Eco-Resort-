            ...
            <div class="row">
                <div class="footer__widget__wrapper">
                    ...
                    <div class="rts__widget">
                        ...
                        <ul>
                            <li><a href="index.html" aria-label="footer__link">Home</a></li>
                            <li><a href="about.html" aria-label="footer__link">About Us</a></li>
                            <li><a href="gallery.html" aria-label="footer__link">Gallery</a></li>
                            <li><a href="contact.html" aria-label="footer__link">Contact</a></li>
                        </ul>
                    </div>
                    <div class="rts__widget">
